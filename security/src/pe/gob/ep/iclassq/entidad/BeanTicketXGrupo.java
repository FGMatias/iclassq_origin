...
public class BeanTicketXGrupo {
	...
	private Integer generadosCantidad;
	private Integer canceladosCantidad;
	private Integer ausentesCantidad;
	private String maxEsperaGenerados;
	...
	public Integer getGeneradosCantidad() {
		return generadosCantidad;
	}
	public void setGeneradosCantidad(Integer generadosCantidad) {
		this.generadosCantidad = generadosCantidad;
	}
	public Integer getCanceladosCantidad() {
		return canceladosCantidad;
	}
	public void setCanceladosCantidad(Integer canceladosCantidad) {
		this.canceladosCantidad = canceladosCantidad;
	}
	public Integer getAusentesCantidad() {
		return ausentesCantidad;
	}
	public void setAusentesCantidad(Integer ausentesCantidad) {
		this.ausentesCantidad = ausentesCantidad;
	}
	public String getMaxEsperaGenerados() {
		return maxEsperaGenerados;
	}
	public void setMaxEsperaGenerados(String maxEsperaGenerados) {
		this.maxEsperaGenerados = maxEsperaGenerados;
	}
