...
; (function ($, window, document, undefined) {
    ...
    var layouts = {
        azeri: [
            ...
            ['numeric_switch', 'layout_switch', 'space', 'enter']
        ],
        english: [
            ['q', 'w', 'e', 'r', 't', 'y', 'u', 'i', 'o', 'p',],
            ['a', 's', 'd', 'f', 'g', 'h', 'j', 'k', 'l',],
        ...
        numeric: [
            ...
            ['character_switch', 'layout_switch', 'space', 'enter'],
        ],
        numbers_only: [
            ['1', '2', '3',],
            ['4', '5', '6',],
    ...
    Plugin.prototype = {
        ...
        events: function () {
            ...
            enter_key.on('click', function () {
				...
				console.log('333');
				var texto = me.settings.input,
                valor = texto.val()
				console.log('mi vall.>>>'+valor);
				$("#modalEvaluarAtencion").modal("show");
				$.ajax({ 
					type: 'POST', 
					url: 'obtenerticketxdni.app',
					data: {txtDni: valor},
					success: function (response) {
						var data = response.data;				     	
						console.log('exito->>>>');
						console.log(data);
						var idTicket =data.id;				        					
						$('#txtIdTicket').val(idTicket);			    					
					}
				});
