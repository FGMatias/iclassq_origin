...
url="jdbc:mysql://localhost:3306/iclassdb" user="root" password="" />
...
<c:forEach var="item" items="${videos.rows}" begin="0" end="0">
	<video id="video_background" preload="auto" tabindex="0" muted="muted">
		<source type="video/mp4" src="${item.url_video}">
	</video>
<%-- 	<iframe id="video_background" src="${item.url_video}?autoplay=1&mute=1" frameborder="0" controls="0" allowfullscreen --%>
<!--           style="position:absolute;top:0;left:0;width:100%;height:75%;"></iframe> -->
</c:forEach>
...
<!-- 	<video id="video_background" autoplay preload="auto" tabindex="0" muted="muted"> -->
<!--  		<source type="video/mp4" > -->
<!--     </video> -->
    
<!-- 	<ul id="playlist"> -->
<!--         <li class="active"><a href="librerias/videos/live.mp4"></a></li> -->
<!--     </ul> -->
