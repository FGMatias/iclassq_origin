...
<style type="text/css">
#bgImgCenter{
    background-image: url("librerias/imagenes/feliz_cumple04.gif");
...
<div class="container" >
        ...
        <div class="row">
        	<div class="dni-descripcion col-sm-12" id="bgImgCenter" >
        		<br>
        		<span id="txtPersona"></span><br>
        		<span id="txtMensaje"></span><br>
        		<br>
	        </div>         
