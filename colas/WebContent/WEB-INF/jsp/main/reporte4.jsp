...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">    
    <a href="main.app" class="brand-link">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Reporte por Usuario</li>
            </ol>
          </div>
        </div>
      </div>
        	...
        	<div class="col-12">
          		<div class="card">
              			...
              			<div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <button type="button" class="btn btn-primary" id="btnBuscarXUsuario">Buscar</button>&nbsp;
                                    <button type="button" class="btn btn-danger">Cancelar</button>&nbsp;
                                    <button type="button" class="btn btn-success" id="btnExportUsuario">Exportar</button>&nbsp;
            		...
            		<table id="tblListadoTicketXUsuario" class="table table-bordered table-striped">
                	  ...
                	  <div id="graficaListadoXUsuario" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
            		</div>
          		</div>
        	</div>      
       	</div>    
...
function Construyecabecera(presentacion){
	...
	$('#tblListadoTicketXUsuario thead').empty();		
	html = '<tr>' ;
	...
	html =html + '</tr>';
	$('#tblListadoTicketXUsuario thead').append(html);

}
			
function Construyehtml(data, iApellido, presentacion){
	if ($.fn.DataTable.isDataTable('#tblListadoTicketXUsuario')) {
		$('#tblListadoTicketXUsuario').DataTable().clear().destroy();
	}
	
	$('#tblListadoTicketXUsuario tbody').empty();					
	...
	for(var i=0; i<data.length; i++){				
			...
			html=html+'</tr>';
			$('#tblListadoTicketXUsuario tbody').append(html);
	}
	
	$('#tblListadoTicketXUsuario').DataTable({
		pageLength: 10,
		lengthChange: false,
		language: {
...
$("#btnBuscarXUsuario").click(function() {
	...
	$.ajax({
		type: 'POST',
		url: 'listaratencionesxusuario.app',
    	data: {idSucursal : idSucursal, idArea : idArea, idUsuario: idUsuario, fechaInicio: fechaInicio, fechaFin: fechaFin},           
...
$("#btnExportUsuario").click(function() {
	console.log("exportar: ");
	$('#tblListadoTicketXUsuario').table2excel({
		name: "Reporte4",
...
//		$("#pnlTicket").printElement();
	...
	var printContents = document.getElementById('tblListadoTicketXUsuario');
    w = window.open();
