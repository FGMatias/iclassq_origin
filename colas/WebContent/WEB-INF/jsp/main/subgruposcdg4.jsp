										...
										<div class="panel-body" style="border: none; box-shadow: none;">
											<div class="row">
												<div class="col-xs-12 col-sm-12">
													<a href="#" onclick="fnGenerarTicket(51, 'F', 'FAMILIA - USUARIO')"><div class="center">
													  <p>USUARIO</p>
													</div></a>
												</div>
											</div>
								...
								<div class="col-xs-12 col-sm-4">
									<div class="panel panel-primary" style="border:none">
										<div class="panel-body" style="border: none; box-shadow: none;">
											<div class="row">
												<div class="col-xs-12 col-sm-12">
													<a href="#" onclick="fnGenerarTicket(57, 'P', 'FAMILIA - PNP')"><div class="center">
													  <p>PNP</p>
													</div></a>
												</div>
											</div>
										...
										<div class="panel-body">
											<div class="row">
												<div class="col-xs-12 col-sm-12" style="position: relative;">
													<a href="#" onclick="fnGenerarTicket(58, 'P', 'FAMILIA - PJ INTERNO')"><div class="center">
													  <p>PJ INTERNO</p>
													</div></a>
												</div>
											</div>
