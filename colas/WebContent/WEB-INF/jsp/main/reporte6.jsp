...
<title>Reporte Mensual por Usuario</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Reporte Mensual por Usuario</li>
            </ol>
          </div>
        </div>
      </div>
...
function Construyecabecera(presentacion){
	...
	$('#tblListadoTicketXMesUsuario thead').empty();		
	html = '<tr>' ;
	...
	html =html + '</tr>';
	$('#tblListadoTicketXMesUsuario thead').append(html);
...
function Construyehtml(data, iApellido, presentacion){
	...
	$('#tblListadoTicketXMesUsuario').DataTable();
...
$("#btnBuscarXMesUsuario").click(function() {
	...
	if (tipoGrafico == 2 && idArea!=0 && idUsuario!=0){
...
// 	    		        data: evNG
	...
	if (tipoGrafico == 2 && idArea==0 && idUsuario==0){
		...
		$.ajax({
			type: 'POST',
			url: 'listaratencionesxmesusuariototal.app',
...
$(document).ready(function() {
	...
	$.ajax({ 
		type: 'POST', 
		url: 'findusuariosventanilla.app',
		data: {idSucursal: idSucursal},		 	    		
		success: function (response) {
			var data = response.data;
			$.each(data, function (index, item) {
