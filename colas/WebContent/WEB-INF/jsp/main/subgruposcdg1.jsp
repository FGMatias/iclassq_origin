...
<div class="row">
										...
										<div class="panel-body" style="border: none; box-shadow: none;">
											<div class="row">
												<div class="col-xs-12 col-sm-12">
													<a href="#" onclick="fnGenerarTicket(49, 'L', 'LABORAL-JUZGADOS')"><div class="center">
													  <p>JUZGADO</p>
													</div></a>
												</div>
											</div>
										...
										<div class="panel-body">
											<div class="row">
												<div class="col-xs-12 col-sm-12" style="position: relative;">
													<a href="#" onclick="fnGenerarTicket(53, 'S', 'LABORAL -SALA')"><div class="center">
													  <p>SALA</p>
													</div></a>
												</div>
											</div>
								...
								<div class="col-xs-12 col-sm-4">
									<div class="panel panel-primary" style="border:none">
										<div class="panel-body">
											<div class="row">
												<div class="col-xs-12 col-sm-12" style="position: relative;">
													<a href="#" onclick="fnMostraGruposPJI()"><div class="center">
													  <p>PJ INTERNO</p>
													</div></a>
												</div>
											</div>
	...
	<div class="row">
			<div class=" col-xs-12 col-md-2">
				<a id="btnRegresar3Nivel" class="atras" >REGRESAR</a>
            </div>
	</div>
</div>
	...
	<script>	
		...
		$("#btnRegresar3Nivel").click(function() {
			var area =2;
			var dni = '${dni}';		
			var tipoDoc = '${tipoDoc}';
			var persona = '${persona}';
		...
		function fnMostraGruposPJI(){
			var area =2;
			var dni = '${dni}';
			var tipoDoc = '${tipoDoc}';
			var persona = '${persona}';
			var prioridad = '${prioridad}';
			window.location.href = 'subgruposcdg1_pji.app?area='+area+'&dni='+dni+'&tipoDoc='+tipoDoc+'&persona='+persona+'&prioridad='+prioridad;
		}
