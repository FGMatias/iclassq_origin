										...
										<div class="panel-body" style="border: none; box-shadow: none;">
											<div class="row">
												<div class="col-xs-12 col-sm-12">
													<a href="#" onclick="fnGenerarTicket(40, 'PI', 'PROPIEDAD INMUEBLE')"><div class="center">
													  <p>PROPIEDAD INMUEBLE</p>
													</div></a>
												</div>
											</div>
										</div>
										...
										<div class="panel-body">
											<div class="row">
												<div class="col-xs-12 col-sm-12" style="position: relative;">
													<a href="#" onclick="fnGenerarTicket(41, 'DP', 'PODERES')"><div class="center">
													  <p>PODERES</p>
													</div></a>
												</div>
											</div>
								...
								<div class="col-xs-12 col-sm-3">
									<div class="panel panel-primary" style="border:none">
										<div class="panel-body">
											<div class="row">
												<div class="col-xs-12 col-sm-12" style="position: relative;">
													<a href="#" onclick="fnGenerarTicket(42, 'NC', 'ASUNTOS NO CONTENCIOSOS')"><div class="center">
													  <p>ASUNTOS NO CONTENCIOSOS</p>
													</div></a>
												</div>
											</div>
										</div>
								...
								<div class="col-xs-12 col-sm-3">
									<div class="panel panel-primary" style="border:none">
										<div class="panel-body">
											<div class="row">
												<div class="col-xs-12 col-sm-12" style="position: relative;">
													<a href="#" onclick="fnGenerarTicket(54, 'VG', 'TRANSFERENCIA VEHICULAR Y GARANTIA MOVILIARIA')"><div class="center">
													  <p>TRANSFERENCIA VEHICULAR Y GARANTIA MOVILIARIA</p>
													</div></a>
												</div>
											</div>
										</div>
								...
								<div class="col-xs-12 col-sm-3 col-centered">
									<div class="panel panel-primary" style="border:none">
										<div class="panel-body" style="border: none; box-shadow: none;">
											<div class="row">
												<div class="col-xs-12 col-sm-12">
													<a href="#" onclick="fnGenerarTicket(43, 'AS', 'ACTOS SOCIETARIOS')"><div class="center">
													  <p>ACTOS SOCIETARIOS</p>
													</div></a>
												</div>
											</div>
										</div>
...
<!-- 											<div class="row"> -->
<!-- 												<div class="col-xs-12 col-sm-12" style="position: relative;"> -->
<!-- 													<a href="#" onclick="fnGenerarTicket(44, 'OG', 'ORDEN DE GIRO')"><div class="center"> -->
<!-- 													  <p>ORDEN DE GIRO</p> -->
<!-- 													</div></a> -->
<!-- 												</div> -->
<!-- 											</div> -->
								...
								<div class="col-xs-12 col-sm-3 col-centered">
									<div class="panel panel-primary" style="border:none">
										<div class="panel-body">
											<div class="row">
												<div class="col-xs-12 col-sm-12" style="position: relative;">
													<a href="#" onclick="fnGenerarTicket(59, 'LP', 'COMPRA VENTA LOS PORTALES')"><div class="center">
													  <p>COMPRA VENTA LOS PORTALES </p>
													</div></a>
												</div>
											</div>
										</div>
								...
								<div class="col-xs-12 col-sm-3 col-centered">
									<div class="panel panel-primary" style="border:none">
										<div class="panel-body">
											<div class="row">
												<div class="col-xs-12 col-sm-12" style="position: relative;">
													<a href="#" onclick="fnGenerarTicket(46, 'CE', 'CONSTITUCION DE EMPRESAS')"><div class="center">
													  <p>CONSTITUCION DE EMPRESAS</p>
													</div></a>
												</div>
											</div>
										</div>
