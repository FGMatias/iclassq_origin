            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="reportexarea.app" class="nav-link active">
                  ...
                  <p>Reporte <br>Detallado</p>
                </a>
              </li>
<!--               <li class="nav-item"> -->
<!--                 <a href="reportexdni.app" class="nav-link active"> -->
<!--                   <i class="far fa-circle nav-icon"></i> -->
<!--                   <p>Reporte <br>por DNI</p> -->
<!--                 </a> -->
<!--               </li> -->

<!--               <li class="nav-item"> -->
<!--                 <a href="reportexalgoritmo.app" class="nav-link active"> -->
<!--                   <i class="far fa-circle nav-icon"></i> -->
<!--                   <p>Reporte por Algoritmo</p> -->
<!--                 </a> -->
<!--               </li> -->
              <li class="nav-item">
