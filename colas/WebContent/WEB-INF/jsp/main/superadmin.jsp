        	...
        	<div class="col-12">
          		<div class="card">
            		<div class="card-header">
            			<button id="btnOpenModal" type="button" class="btn btn-primary" data-toggle="modal" title="Nueva Empresa"><i class="fas fa-plus"></i>&nbsp; Nueva Empresa</button>
            		</div>              
            		<div class="card-body">
...
<!-- editar empresa -->
	...
	<!-- nuevo admin  -->
	<div class="modal" id="nuevoAdminEmpresa">
		  <div class="modal-dialog modal-lg">
		    <div class="modal-content">		
		      <!-- Modal Header -->
		      <div class="modal-header modal-header-primary">
...
<!-- 												<input class="form-control" type="text" id="txtAdminIp" placeholder="127.0.0.1" required/> -->
								...
								<button type="submit" id="btnSaveAdmin" class="btn btn-primary" title="Grabar"><i class="fas fa-save"></i></button>
	        					<button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-window-close" aria-hidden="true"></i></button>
							</form>
					</fieldset>
		      </div>	
	...
	$.ajax({
		...
		success: function (response) {
			...
			for(var i=0; i<data.length; i++){				
				...
				'<td><button type="button" class="btn btn-success" onclick="fnEditarEmpresa('+data[i].id+')"><i class="fa fa-edit"></i></button>&nbsp;<button type="button" class="btn btn-warning" onclick="fnAddAdmin('+data[i].id+')" title="Asignar Admin"><i class="fa fa-user" aria-hidden="true"></i></button></td>' +
			  '</tr>';	        					
...
$("#btnSaveAdmin").click(function() {
	...
	var email = $("#txtAdminEmail").val();
		...
		$.ajax({ 
	 		type: 'POST', 
	 		url: 'grabarusuarioadmin.app',
	 		data: {idEmpresa: idEmpresa, aPaterno: aPaterno, aMaterno: aMaterno, nombres: nombres, login: login, email: email}, 	    		
	 		success: function (response) {
	 			var mensaje = response.message;	 			
	 			var data = response.data;
